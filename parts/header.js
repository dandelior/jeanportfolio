    ...
    <>
        <header>
            <div className="header-inner">
                ...
                <Link href="/">
                    <a className="logo">
                        <svg width="100%" height="100%" className="logo-big" viewBox="0 0 218 218" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" style={{ fillRule: 'evenodd', clipRule: 'evenodd', strokeLinejoin: 'round', strokeMiterlimit: '1.41421' }}>
                        ...
                        <p className="logo-small">JEAN GUTIERREZ</p>
                    </a>
                </Link>
